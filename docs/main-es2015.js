...
let LoginComponent = class LoginComponent {
    constructor(auth, router, builder, toastr) {
        this.auth = auth;
        this.router = router;
        ...
        this.check = lodash__WEBPACK_IMPORTED_MODULE_5__["debounce"](() => this.check_email(this.form.value), 1000);
    }
    ngOnInit() {
    ...
    signin(form) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.show_spinner();
            const session = yield this.auth.signin(form);
...
let ResetComponent = class ResetComponent {
    constructor(builder, auth, toastr) {
        this.builder = builder;
        this.auth = auth;
        this.toastr = toastr;
        this.spinner = true;
        ...
        this.check = lodash__WEBPACK_IMPORTED_MODULE_1__["debounce"](() => this.check_email(this.form.value), 1000);
    }
    ngOnInit() {
        this.form = this.builder.group({
    ...
    reset(form) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.show_spinner();
            const reset = yield this.auth.reset(form);
